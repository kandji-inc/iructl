...
class CustomApp(MemberBase[AppInfoFile, CustomAppPayload]):
    ...
    def _update_payload(self, config: ApiConfig) -> dict[str, Any]:
        ...
        payload: dict[str, Any] = {
            ...
            "audit_script": self.audit.normalized_content if self.audit else "",
            "preinstall_script": self.preinstall.normalized_content if self.preinstall else "",
            "postinstall_script": self.postinstall.normalized_content if self.postinstall else "",
